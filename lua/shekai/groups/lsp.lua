...
local m =
{
	DiagnosticError = { fg = p.deep_blood }, -- Virtual text/signs for syntax errors
    ...
    DiagnosticUnderlineError    = { fg = p.deep_blood, undercurl = true, bold = true }, -- Wavy underline for errors
