...
function M.setup()
    ...
    local function update_borders()
        ...
        local targets = { "WinSeparator", "LazyGitBorder", "FloatBorder", "FloatTitle", "BufferLineIndicatorSelected", "CursorLineNr", "MiniIndentscopeSymbol", "FzfLuaBorder", "GlanceBorderInactive"}
